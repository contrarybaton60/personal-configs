...
sudo apt remove drawing hypnotix breeze-icon-theme papirus-icon-theme numix-icon-theme libreoffice-base libreoffice-math

# Install Programs from apt
sudo apt install nala lutris steam-installer simplescreenrecorder libqt5xml5 virt-manager tlp tlp-rdw

# Add Adoptium JDK repository because Minecraft requires Java
...
sudo ./INSTALL
am update
am install gimp-git prismlauncher-qt5 stellarium tor-browser vscodium
