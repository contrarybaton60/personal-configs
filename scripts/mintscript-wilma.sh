...
# Personal install script for Linux Mint 22 "Wilma".
...
sudo apt remove mintchat yaru-theme-icon papirus-icon-theme thunderbird

# Update System
sudo apt update && sudo apt upgrade

# Install packages through apt
sudo apt install bibletime qt5ct virt-manager ffmpeg
